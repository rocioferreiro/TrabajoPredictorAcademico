...
Primero, se produjo un modelo GBM, modelo de incremento estocástico del gradiente, observamos que en el se le da mayor prioridad al primer parcial de Algebra y al parcial de Análisis por sobre el resto. Este tiene una precisión del 97% segun las pruebas, ya que de los 32 alumnos que utilizamos en dichas pruebas, predijo correctamente quienes no desertaron, y de todas las deserciones, solo una fue un falso positivo.
...
|    | Predice que la da de Baja | Predice que NO la da de Baja   |
| :------- | :------: | -------: |
| La da de Baja   | 8      | 0  |
| NO la da de Baja  | 1     | 23  |

## Random Forest

Luego, generamos un modelo RandomForest, o en español, "Bosques Aleatorios". Este es el único modelo que le dió la menor importancia a la nota de Análisis. Este tiene una exactitud del 93% según las pruebas realizadas, categorizando correctamente a los alumnos que no desertaron, y de los que predijo que se desincribirían de la carrera, solo dos fueron falsos positivos.
...
| :------- | :------: | -------: |
| La da de Baja   | 7      | 2  |
| NO la da de Baja  | 0     | 23  |


## NNET

Seguidamente, elaboramos un modelo NNET, modelo con una red neuronal. Este modelo también priorizó a Análisis, y tiene una precisión del 94%, y de todos los alumnos analizados por el mismo, predijo correctamente los que dejaron y no la carrera, aun así, predijo un falso positivo en cada categoría.
...
| :------- | :------: | -------: |
| La da de Baja   | 8      | 1  |
| NO la da de Baja  | 1     | 22  |


## GLM

Por ultimo, producimos un modelo GLM, modelo lineal generalizado. Este último modelo prioriza también a Análisis en mayor medida que el resto de las calificaciones, y demostró una precisión del 84%, ya que de las pruebas realizadas, marcó a 3 alumnos que se desincribieron como si no lo hubieran hecho, falsos negativos, y a un alumno que sigue en la carrera como desertor,falso positivo, dando un total de cuatro errores en la predicción.
